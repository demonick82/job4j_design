...
public abstract class Food {
    ...
    public double expirePercent() {
        double shelfLife = ChronoUnit.DAYS.between(createDate, expiryDate);
        double remainDays = ChronoUnit.DAYS.between(LocalDate.now(), expiryDate);
